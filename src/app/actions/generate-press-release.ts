...
{"titles":["제목1","제목2","제목3","제목4","제목5"],"summaries":["요약1","요약2","요약3","요약4","요약5"],"content":"본문 전체(반드시 각 문단 사이에 \\\\n\\\\n 을 넣어 문단을 명확히 분리할 것)"}`;
...
- 분량: 1200~1500자
- [형식 필수] 본문은 헤드라인, 도입부, 본문, 인용문, 마무리 등 모든 영역이 시각적으로 명확히 분리되도록 각 문단 끝마다 반드시 줄바꿈 기호(\\\\n\\\\n)를 2번 연속 삽입하여 물리적 단락을 나눌 것. 절대 하나의 거대한 문단으로 합치지 마세요.
